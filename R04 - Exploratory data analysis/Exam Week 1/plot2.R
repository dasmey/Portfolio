...
sub_power$Full_Date <- strptime(fulldate, format = "%Y-%m-%d %H:%M:%S")

## Now we can plot
plot(sub_power$Global_active_power ~ sub_power$Full_Date, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
